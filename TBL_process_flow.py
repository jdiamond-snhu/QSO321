...
fig.add_trace(go.Scatter(x=[5.0], y=[9.7], mode="text", text=["<b>TBL TARGET GOAL</b>"], textposition="top center"))
...
# Creates an empty column on the left (20%), main center column (60%), and empty right column (20%)
